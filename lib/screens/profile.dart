              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/user/cover.jpg'),
                          fit: BoxFit.cover),
                ...
                Column(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage:
                          AssetImage('assets/images/user/Mike Tyler.jpg'),
                      radius: 70.0,
                    ),
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                        'assets/images/user/samantha.jpg')),
                                borderRadius: BorderRadius.circular(10.0)),
                          ),
                          SizedBox(height: 5.0),
                          Text('Samantha',
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                        'assets/images/user/Sam Wilson.jpg'),
                                    fit: BoxFit.cover),
                                borderRadius: BorderRadius.circular(10.0)),
                          ),
                          SizedBox(height: 5.0),
